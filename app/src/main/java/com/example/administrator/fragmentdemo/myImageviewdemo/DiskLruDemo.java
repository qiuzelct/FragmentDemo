...
import com.example.administrator.fragmentdemo.myImageviewdemo.DiskLruCache;
...
public class DiskLruDemo {
    ...
    private com.example.administrator.fragmentdemo.myImageviewdemo.DiskLruCache disk;
    ...
    public DiskLruDemo(Context context){
        ...
        try {
            ...
            disk= DiskLruCache.open(cacheDir, getAppVersion(context), 1, DISK_CACHE_SIZE);
        } catch (IOException e) {
            e.printStackTrace();
        }
